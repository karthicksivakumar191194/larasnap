            ...
            <div class="card-body">
               <form method="POST" action="{{ route('settings.store') }}"  class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label for="admin-email" class="control-label">Admin Email</label> 
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label for="date-time-format" class="control-label">Date Time Format</label>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label for="time-format" class="control-label">Time Format</label>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label for="entries-per-page" class="control-label">Entries Per Page</label> 
