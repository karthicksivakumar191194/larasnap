@extends('larasnap::layouts.app', ['class' => 'permission-edit'])
      ...
      <div class="card shadow mb-4">
         <div class="card-body">
            <div class="card-body">
               ...
               <br> <br> 
               <form method="POST" action="{{ route('permissions.update', $permission->id) }}" class="form-horizontal" autocomplete="off">
			   @csrf
			   @method('PUT')
               <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input name="name" type="text" id="name" class="form-control lower-case" value="{{ old('name', $permission->name) }}">
                           @error('name')
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input name="label" type="text" id="label" class="form-control" value="{{ old('label', $permission->label) }}">
                           @error('label')
                           <span class="text-danger">{{ $message }}</span>
                           @enderror 							
                        </div>
